...
const currentStudent = {
    id: String(window.studentProfileData?.id || 'ST002'),
    name: window.studentProfileData?.name || 'Tsi',
    batch: window.studentProfileData?.batch || 'Batch 1',
    email: window.studentProfileData?.email || 'tsi@lms.com'
};
